        ...
        <div className="max-w-2xl mx-auto space-y-8">
          <Card className="p-8 md:p-12 space-y-8">
            <div className="space-y-6">
              <div className="flex items-start gap-4 hover-elevate rounded-lg p-4 -m-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <a
                    href="mailto:inpeacewelive11@gmail.com"
                    className="text-primary hover:underline break-all"
                    data-testid="link-email"
                  >
                    inpeacewelive11@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 hover-elevate rounded-lg p-4 -m-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <a
                    href="https://instagram.com/shouqalsulaiman_"
                    target="_blank"
            ...
            <div className="flex justify-center pt-4">
              <Button
                size="lg"
                onClick={() => window.location.href = 'mailto:inpeacewelive11@gmail.com'}
